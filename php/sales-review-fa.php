        ...
        <?php
            ...
            <header class ="header">
                ...
                <ul>
                    ...
                    <li><a href="fa-ticket.php#sec" id="user-bar" class="active">User</a>
                        <ul class="dropdown">
                            <?php
                                if(isset($_SESSION['valid3'])){
                                ...
                                echo "<li><a href='#' class= 'active'>Sales Review</a></li>";
            ...
            <div class="container" id="container">
                ...
                <?php
                    ...
                    for($i = 0; $i < 12; $i++){
                        ...
                        WHERE P.MATCH_ID = M.MATCH_ID AND M.TEMP_ID = T.TEMP_ID AND T.MATCH_HOME = $id AND
                        ...
                        for($i=0; $i<7; $i++){
                            ...
                            FROM PAYMENT P,TICKETMATCH M, TEMP_TICKET T
                            WHERE P.MATCH_ID = M.MATCH_ID AND M.TEMP_ID = T.TEMP_ID AND T.MATCH_HOME = $id 
